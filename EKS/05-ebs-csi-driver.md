...
```
eksctl create addon --name aws-ebs-csi-driver --cluster roboshop --service-account-role-arn arn:aws:iam::<AWS-ACCOUNT-ID>:role/AmazonEKS_EBS_CSI_DriverRole --force
```
